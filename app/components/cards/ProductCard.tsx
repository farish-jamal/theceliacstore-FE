  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile Quick View Button - Top Right */}
        {isMobile && productData && (
          <div 
          ...
          >
            <button
              ...
              className="bg-white/90 backdrop-blur-sm rounded-full p-2 shadow-md border border-gray-200 hover:bg-white transition-colors duration-200"
