...
import { BundleParams } from "../apis/getBundles";
...
export const useBundleFilters = () => {
  ...
  const currentFilters = useMemo(() => {
    ...
    return {
      ...
      sub_category: params.get("sub_category") || undefined,
      rating: params.get("rating") ? parseInt(params.get("rating")!) : undefined,
      is_best_seller: params.get("is_best_seller") === "true",
      brands: params.get("brands") ? params.get("brands")!.split(",") : undefined,
      sort_by: params.get("sort_by") || "created_at",
    };
  }, [searchParams]);

  // Update filters and URL
  const updateFilters = useCallback((newFilters: Partial<BundleParams>) => {
    const params = new URLSearchParams(searchParams);
  ...
  const updateFilter = useCallback((key: keyof BundleParams, value: BundleParams[keyof BundleParams]) => {
  ...
  const getApiParams = useMemo((): BundleParams => {
    ...
    if (currentFilters.sort_by) params.sort_by = currentFilters.sort_by as BundleParams["sort_by"];
